...
<div class="modal fade" id="editarAsociacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {!! Form::open(array('route'=>['admin.asociaciones.edit', $datos->id_asociacion], 'method'=>'GET')) !!}
        ...
        <div class="form-group row">
          ...
          <br>
          <div class="col-md-10 col-md-offset-2">
            <input type="file" name="imagen_aE" id="cargarImagen">
            <br>
          </div>
          <div class="col-md-12">
            <img src="#" alt="" class="editarImagenUsuario" id="cajaImagenAsociacion">
    ...
    function readURL(input) {
      if (input.files && input.files[0]) {
        ...
        reader.onload = function(e) {
          $('#cajaImagenAsociacion').attr('src', e.target.result);
        }
